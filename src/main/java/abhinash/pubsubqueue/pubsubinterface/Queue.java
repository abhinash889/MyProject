...
import abhinash.pubsubqueue.handler.TopicHandler;
import abhinash.pubsubqueue.model.Message;
import abhinash.pubsubqueue.model.Topic;
import abhinash.pubsubqueue.model.TopicSubscriber;
...
public class Queue {
    ...
    public void removeSubscription(@NonNull final ISubscriber subscriber, @NonNull final Topic topic) {
        topic.removeSubscriber(new TopicSubscriber(subscriber));
        for (TopicSubscriber topicSubscriber : topic.getSubscribers()) {
            System.out.println(topicSubscriber.getSubscriber().getId());
        }
        System.out.println(subscriber.getId() + " removed from topic: " + topic.getTopicName());
    }
